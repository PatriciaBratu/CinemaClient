                           ...
                           int body_data_fields_count, char **cookies, int cookies_count)
{
    ...
    */
    for (int i = 0; i < body_data_fields_count; i++)
    {
        ...
        {
            strcat(body_data_buffer, "&"); // separate key-value pairs
        }
    }
...
char *compute_post_request2(char *host, char *url, char *content_type,
...
// === Step 3: Extra Headers (ex: Authorization: Bearer...) ===
for (int i = 0; i < headers_count; i++) {
...
// === Step 6: Final newline (end of headers) ===
compute_message(message, "");
...
char *compute_delete_request2(char *host, char *url, char *content_type,
    char **cookies, int cookies_count,
    char**headers, int headers_count)
{
char *message = calloc(BUFLEN, sizeof(char));
...
char *compute_put_request2(char *host, char *url, char *content_type,
    char **body_data, int body_data_fields_count,
    char **headers, int headers_count) {
